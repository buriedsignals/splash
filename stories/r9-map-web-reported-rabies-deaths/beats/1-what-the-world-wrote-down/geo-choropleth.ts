 ...
 */
export const RABIES_2024_STUDY = [
  "AFG",
  "AGO",
  "ALB",
  "AND",
 ...
 *  `map-beat/assets/geo.ts`'s own `RABIES_BREAKS` uses for the same quantity (CO₂ per capita):
 ...
 *  boundaries for it. */
export const RABIES_BREAKS = [1, 5, 25, 100, 250];
