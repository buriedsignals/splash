...
SCAFFOLD: this beat's code was scaffolded `--from proof/scrolly-cartogram-europe-lowcarbon` — read that beat's own BRIEF.md and its
runner/plan/driver/directed component (marked SCAFFOLD: where they are its own subject) before writing this table.

SCAFFOLD: read `skills/scrolly/references/types/cartogram.md` for this type's own scroll gestures (what a
