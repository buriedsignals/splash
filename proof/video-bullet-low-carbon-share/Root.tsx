...
import {
  DirectedBulletVideo,
  type DirectedBulletVideoProps,
} from "./DirectedBulletVideo";
import { BULLET_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-bullet-low-carbon-share-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: BULLET_VIDEO_TIMING,
} as unknown as DirectedBulletVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedBulletVideo}
      durationInFrames={BULLET_VIDEO_TIMING.total}
      fps={BULLET_VIDEO_TIMING.fps}
      width={width}
      height={height}
