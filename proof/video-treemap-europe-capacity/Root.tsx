...
import {
  DirectedTreemapVideo,
  type DirectedTreemapVideoProps,
} from "./DirectedTreemapVideo";
import { TREEMAP_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-treemap-europe-capacity-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: TREEMAP_VIDEO_TIMING,
} as unknown as DirectedTreemapVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedTreemapVideo}
      durationInFrames={TREEMAP_VIDEO_TIMING.total}
      fps={TREEMAP_VIDEO_TIMING.fps}
      width={width}
      height={height}
