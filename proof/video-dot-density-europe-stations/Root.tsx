...
import {
  DirectedDotDensityVideo,
  type DirectedDotDensityVideoProps,
} from "./DirectedDotDensityVideo";
import { DOT_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-dot-density-europe-stations-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: DOT_VIDEO_TIMING,
} as unknown as DirectedDotDensityVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedDotDensityVideo}
      durationInFrames={DOT_VIDEO_TIMING.total}
      fps={DOT_VIDEO_TIMING.fps}
      width={width}
      height={height}
