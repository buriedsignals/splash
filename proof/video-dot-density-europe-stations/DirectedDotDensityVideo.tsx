/**
 * The Remotion composition: `DotFrame` at the current frame, drawn only once the embedded faces are in,
...
export type DirectedDotDensityVideoProps = DotFrameProps & { faces: EmbeddedFace[] };
...
export function DirectedDotDensityVideo(props: DirectedDotDensityVideoProps) {
  ...
  return <AbsoluteFill style={{ backgroundColor: props.colours?.ground }}>{ready ? <DotFrame {...props} at={frame} svgRef={ref} /> : null}</AbsoluteFill>;
}
