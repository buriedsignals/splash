...
import {
  DirectedPyramidVideo,
  type DirectedPyramidVideoProps,
} from "./DirectedPyramidVideo";
import { PYRAMID_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-population-pyramid-swiss-age-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: PYRAMID_VIDEO_TIMING,
} as unknown as DirectedPyramidVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedPyramidVideo}
      durationInFrames={PYRAMID_VIDEO_TIMING.total}
      fps={PYRAMID_VIDEO_TIMING.fps}
      width={width}
      height={height}
