...
import {
  DirectedStackedBarVideo,
  type DirectedStackedBarVideoProps,
} from "./DirectedStackedBarVideo";
import { STACKED_BAR_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-stacked-bar-lowcarbon-growth-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: STACKED_BAR_VIDEO_TIMING,
} as unknown as DirectedStackedBarVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedStackedBarVideo}
      durationInFrames={STACKED_BAR_VIDEO_TIMING.total}
      fps={STACKED_BAR_VIDEO_TIMING.fps}
      width={width}
      height={height}
