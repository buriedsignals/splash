...
describe("statesFor", () => {
  it("should open on the title card alone, then the 2000 levels", () => {
  ...
  it("should stack the gains at reveal, and lay the copies, detach and re-sort at subject", () => {
    expect(reveal).toEqual({ ...reference, grow: 1 });
    expect(subject).toEqual({ ...reveal, copies: 1, detach: 1, reorder: 1 });
  });
