...
import {
  DirectedGroupedBarVideo,
  type DirectedGroupedBarVideoProps,
} from "./DirectedGroupedBarVideo";
import { GROUPED_BAR_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-grouped-bar-wind-vs-solar-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: GROUPED_BAR_VIDEO_TIMING,
} as unknown as DirectedGroupedBarVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedGroupedBarVideo}
      durationInFrames={GROUPED_BAR_VIDEO_TIMING.total}
      fps={GROUPED_BAR_VIDEO_TIMING.fps}
      width={width}
      height={height}
