...
| 5 | not everyone started from the same place: Germany had 71 points to gain, Norway 2 | **measure** | a bar from each 2015 dot up to 100 %, Germany's and Norway's named |
| 6 | the reading line | **pull back** | the static plate |

## Precision

- **Laid out in the reader's pixels**: one scale, 0 to 100 %, for both rails; labels relaxed so no two touch; a phone
