...
middle stops at 6 while the two ends climb to 18 and 16.
...
2. **The story** — the axis across the whole frame, « 0 % » and « 100 % bas-carbone » under its ends, the squares
   standing on it.
3. **No end card** — the video ends on the three blocks on the parted axis, the cuts « 60 % » and « 75 % » ruled in the
   accent, each block's count over it, « 6 pays » ringed; the credit on one line. 18 s.
...
| `conclusion` | only 6 in the middle | **name** | a ring closes round « 6 pays »; the credit | 6 × 4 < 40 |
