...
import {
  DirectedWaterfallVideo,
  type DirectedWaterfallVideoProps,
} from "./DirectedWaterfallVideo";
import { WATERFALL_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-waterfall-germany-electricity-bridge-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: WATERFALL_VIDEO_TIMING,
} as unknown as DirectedWaterfallVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedWaterfallVideo}
      durationInFrames={WATERFALL_VIDEO_TIMING.total}
      fps={WATERFALL_VIDEO_TIMING.fps}
      width={width}
      height={height}
