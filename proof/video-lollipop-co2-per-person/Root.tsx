...
import {
  DirectedLollipopVideo,
  type DirectedLollipopVideoProps,
} from "./DirectedLollipopVideo";
import { LOLLIPOP_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-lollipop-co2-per-person-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: LOLLIPOP_VIDEO_TIMING,
} as unknown as DirectedLollipopVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedLollipopVideo}
      durationInFrames={LOLLIPOP_VIDEO_TIMING.total}
      fps={LOLLIPOP_VIDEO_TIMING.fps}
      width={width}
      height={height}
