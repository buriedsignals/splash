...
import {
  DirectedDivergingStackVideo,
  type DirectedDivergingStackVideoProps,
} from "./DirectedDivergingStackVideo";
import { DIVERGING_STACKED_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-diverging-stacked-electricity-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: DIVERGING_STACKED_VIDEO_TIMING,
} as unknown as DirectedDivergingStackVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedDivergingStackVideo}
      durationInFrames={DIVERGING_STACKED_VIDEO_TIMING.total}
      fps={DIVERGING_STACKED_VIDEO_TIMING.fps}
      width={width}
      height={height}
