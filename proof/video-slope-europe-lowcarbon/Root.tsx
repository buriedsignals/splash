...
import {
  DirectedSlopeVideo,
  type DirectedSlopeVideoProps,
} from "./DirectedSlopeVideo";
import { SLOPE_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-slope-europe-lowcarbon-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: SLOPE_VIDEO_TIMING,
} as unknown as DirectedSlopeVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedSlopeVideo}
      durationInFrames={SLOPE_VIDEO_TIMING.total}
      fps={SLOPE_VIDEO_TIMING.fps}
      width={width}
      height={height}
