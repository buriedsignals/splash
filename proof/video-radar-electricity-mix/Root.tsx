...
import {
  DirectedRadarVideo,
  type DirectedRadarVideoProps,
} from "./DirectedRadarVideo";
import { RADAR_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-radar-electricity-mix-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: RADAR_VIDEO_TIMING,
} as unknown as DirectedRadarVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedRadarVideo}
      durationInFrames={RADAR_VIDEO_TIMING.total}
      fps={RADAR_VIDEO_TIMING.fps}
      width={width}
      height={height}
