...
import {
  DirectedHexGridVideo,
  type DirectedHexGridVideoProps,
} from "./DirectedHexGridVideo";
import { HEX_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-hex-grid-europe-protection-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: HEX_VIDEO_TIMING,
} as unknown as DirectedHexGridVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedHexGridVideo}
      durationInFrames={HEX_VIDEO_TIMING.total}
      fps={HEX_VIDEO_TIMING.fps}
      width={width}
      height={height}
