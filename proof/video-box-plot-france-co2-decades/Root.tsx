...
import {
  DirectedBoxplotVideo,
  type DirectedBoxplotVideoProps,
} from "./DirectedBoxplotVideo";
import { BOXPLOT_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-box-plot-france-co2-decades-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: BOXPLOT_VIDEO_TIMING,
} as unknown as DirectedBoxplotVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedBoxplotVideo}
      durationInFrames={BOXPLOT_VIDEO_TIMING.total}
      fps={BOXPLOT_VIDEO_TIMING.fps}
      width={width}
      height={height}
