...
import {
  DirectedParallelVideo,
  type DirectedParallelVideoProps,
} from "./DirectedParallelVideo";
import { PARALLEL_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-parallel-coordinates-electricity-mix-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: PARALLEL_VIDEO_TIMING,
} as unknown as DirectedParallelVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedParallelVideo}
      durationInFrames={PARALLEL_VIDEO_TIMING.total}
      fps={PARALLEL_VIDEO_TIMING.fps}
      width={width}
      height={height}
