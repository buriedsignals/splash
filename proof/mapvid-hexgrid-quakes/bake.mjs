// The bake for the hex-grid VIDEO beat: one world camera, one basemap capture, every quake epicentre
...
//
//   bun proof/mapvid-hexgrid-quakes/bake.mjs   # → proof/mapvid-hexgrid-quakes/plate
//
// The plate is baked at the EXACT size the video draws it (940 × 540 inside a 1080 × 1080
// composition), never at a third size: a plate baked at one size and drawn into a box of another
// aspect offsets every hexagon from the coastline beneath it, which is a silent geographic lie.
...
const width = Number(flag("--width", "940"));
