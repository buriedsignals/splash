 ...
 * - `conclusion`: 240 frames. Germany — the tenth — slides into the gap and fits; then every bar returns to its row, the
 *   whole ranking, the five bracketed with their sum; the credit.
 * - `hold`: 90 frames.
 *
 * Total: 891 frames, 29.7 seconds at 30 fps.
 */
...
export const BAR_VIDEO_TIMING: BeatTiming = {
  ...
  conclusion: { start: 561, duration: 240 },
  hold: { start: 801, duration: 90 },
};
