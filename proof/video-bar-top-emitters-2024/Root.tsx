...
import {
  DirectedBarVideo,
  type DirectedBarVideoProps,
} from "./DirectedBarVideo";
import { BAR_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-bar-top-emitters-2024-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: BAR_VIDEO_TIMING,
} as unknown as DirectedBarVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedBarVideo}
      durationInFrames={BAR_VIDEO_TIMING.total}
      fps={BAR_VIDEO_TIMING.fps}
      width={width}
      height={height}
