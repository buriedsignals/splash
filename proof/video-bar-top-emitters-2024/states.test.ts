...
describe("statesFor", () => {
  it("should open on the title card alone, then the world as one bar", () => {
    expect(establish).toEqual({ title: 1, furniture: 0, world: 0, drop: 0, camera: 0, stack: 0, tenth: 0, source: 0 });
  ...
  it("should slide the tenth into the gap with the credit at conclusion, and hold it exactly", () => {
    expect(conclusion).toEqual({ ...subject, tenth: 1, source: 1 });
