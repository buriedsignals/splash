...
import {
  DirectedScatterVideo,
  type DirectedScatterVideoProps,
} from "./DirectedScatterVideo";
import { SCATTER_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-scatter-income-life-expectancy-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: SCATTER_VIDEO_TIMING,
} as unknown as DirectedScatterVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedScatterVideo}
      durationInFrames={SCATTER_VIDEO_TIMING.total}
      fps={SCATTER_VIDEO_TIMING.fps}
      width={width}
      height={height}
