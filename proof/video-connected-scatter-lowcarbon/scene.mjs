...
export const WINDOWS = Object.freeze({
  ...
  reveal: { travel: [0.02, 0.95] },
  subject: { zoom: [0, 0.4] },
  conclusion: { back: [0, 0.2], lighter: [0.26, 0.7], legs: [0.72, 0.9], source: [0.78, 0.95] },
});
const LINEAR = new Set(["travel", "lighter"]);
...
export function sceneAt(props, frame) {
  ...
  const stepBack = ease(clamp01(lighter * m));
