...
import {
  DirectedDonutVideo,
  type DirectedDonutVideoProps,
} from "./DirectedDonutVideo";
import { DONUT_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-donut-world-co2-share-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: DONUT_VIDEO_TIMING,
} as unknown as DirectedDonutVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedDonutVideo}
      durationInFrames={DONUT_VIDEO_TIMING.total}
      fps={DONUT_VIDEO_TIMING.fps}
      width={width}
      height={height}
