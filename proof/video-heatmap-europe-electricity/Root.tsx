...
import {
  DirectedHeatmapVideo,
  type DirectedHeatmapVideoProps,
} from "./DirectedHeatmapVideo";
import { HEATMAP_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-heatmap-europe-electricity-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: HEATMAP_VIDEO_TIMING,
} as unknown as DirectedHeatmapVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedHeatmapVideo}
      durationInFrames={HEATMAP_VIDEO_TIMING.total}
      fps={HEATMAP_VIDEO_TIMING.fps}
      width={width}
      height={height}
