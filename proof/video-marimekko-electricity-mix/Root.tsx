...
import {
  DirectedMarimekkoVideo,
  type DirectedMarimekkoVideoProps,
} from "./DirectedMarimekkoVideo";
import { MARIMEKKO_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-marimekko-electricity-mix-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: MARIMEKKO_VIDEO_TIMING,
} as unknown as DirectedMarimekkoVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedMarimekkoVideo}
      durationInFrames={MARIMEKKO_VIDEO_TIMING.total}
      fps={MARIMEKKO_VIDEO_TIMING.fps}
      width={width}
      height={height}
