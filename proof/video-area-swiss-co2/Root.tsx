...
import {
  DirectedAreaVideo,
  type DirectedAreaVideoProps,
} from "./DirectedAreaVideo";
import { AREA_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-area-swiss-co2-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: AREA_VIDEO_TIMING,
} as unknown as DirectedAreaVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedAreaVideo}
      durationInFrames={AREA_VIDEO_TIMING.total}
      fps={AREA_VIDEO_TIMING.fps}
      width={width}
      height={height}
