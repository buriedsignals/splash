...
import {
  DirectedSankeyVideo,
  type DirectedSankeyVideoProps,
} from "./DirectedSankeyVideo";
import { SANKEY_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-sankey-electricity-sources-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: SANKEY_VIDEO_TIMING,
} as unknown as DirectedSankeyVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedSankeyVideo}
      durationInFrames={SANKEY_VIDEO_TIMING.total}
      fps={SANKEY_VIDEO_TIMING.fps}
      width={width}
      height={height}
