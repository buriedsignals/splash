...
import {
  DirectedDivergingBarVideo,
  type DirectedDivergingBarVideoProps,
} from "./DirectedDivergingBarVideo";
import { DIVERGING_BAR_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-diverging-bar-eu-per-capita-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: DIVERGING_BAR_VIDEO_TIMING,
} as unknown as DirectedDivergingBarVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedDivergingBarVideo}
      durationInFrames={DIVERGING_BAR_VIDEO_TIMING.total}
      fps={DIVERGING_BAR_VIDEO_TIMING.fps}
      width={width}
      height={height}
