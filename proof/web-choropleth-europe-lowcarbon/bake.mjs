// The bake for the WEB choropleth beat: one Europe camera, one basemap capture per filed direction,
// every study country's shape projected to pixel space.
//
...
//
//   bun proof/web-choropleth-europe-lowcarbon/bake.mjs --size 860x760   # → proof/mapmore-dot-population/plate
