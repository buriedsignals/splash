...
import {
  DirectedLineVideo,
  type DirectedLineVideoProps,
} from "./DirectedLineVideo";
import { LINE_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-line-swiss-co2-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: LINE_VIDEO_TIMING,
} as unknown as DirectedLineVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedLineVideo}
      durationInFrames={LINE_VIDEO_TIMING.total}
      fps={LINE_VIDEO_TIMING.fps}
      width={width}
      height={height}
