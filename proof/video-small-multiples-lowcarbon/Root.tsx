...
import {
  DirectedSmallMultiplesVideo,
  type DirectedSmallMultiplesVideoProps,
} from "./DirectedSmallMultiplesVideo";
import { SMALL_MULTIPLES_VIDEO_TIMING } from "./timing-contract";

export const COMPOSITION_ID = "video-small-multiples-lowcarbon-landscape";

const PLACEHOLDER = {
  faces: [],
  timing: SMALL_MULTIPLES_VIDEO_TIMING,
} as unknown as DirectedSmallMultiplesVideoProps;
...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      id={COMPOSITION_ID}
      component={DirectedSmallMultiplesVideo}
      durationInFrames={SMALL_MULTIPLES_VIDEO_TIMING.total}
      fps={SMALL_MULTIPLES_VIDEO_TIMING.fps}
      width={width}
      height={height}
