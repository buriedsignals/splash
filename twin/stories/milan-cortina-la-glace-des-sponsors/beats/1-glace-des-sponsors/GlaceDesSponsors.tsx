/**
 * Beat: "Sur les 34 Mt de glace, moins de la moitié est imputable aux Jeux" (stacked bar, one bar).
 *
...
export function GlaceDesSponsors({
  parts,
  title,
  limits,
  source,
  ...
  return (
    ...
    >
      ...
      <text x={PAD} y={barTop - 18} fill={ink} fontSize={17} fontWeight={700}>
        {total} millions de tonnes de glace au total
      </text>
      <text
        x={width - PAD}
        y={barTop - 18}
