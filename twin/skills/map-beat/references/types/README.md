...
they write one, once, for the story in front of them, on top of `map-beat`'s one shared
...
`doctrine/references/geo-discipline.md` and `map-beat/SKILL.md`'s own gotchas (the loud
