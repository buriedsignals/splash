...
describe("fetchWithTimeout", () => {
  ...
  it("should send a descriptive user-agent, not an empty one a newsroom's ops team can't identify", async () => {
    ...
    expect(capturedHeaders["user-agent"]).toContain("twin-newsroom-charter");
  });
...
describe("fetchWithTimeout against the real network", () => {
  ...
  // (splash-twin/test/keys.test.ts). It is written to be a useful assertion whether or not THIS
