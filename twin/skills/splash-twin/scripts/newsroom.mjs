...
//                 twin-palette scores each recorded accent against the ground and never recommends
 ...
 * measured against a ground by `twin-palette`, which scores every option it proposes and never
