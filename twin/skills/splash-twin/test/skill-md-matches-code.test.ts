 ...
 * `twin-doctrine/references/geo-discipline.md`, never `../twin-doctrine/...` (six occurrences of the
 ...
 * guard does not follow it, on purpose: `splash-twin`'s own Tuning-knobs table has a row — "How many
 ...
 *    roughly half of `twin-chart-beat`'s own Tuning-knobs rows name their constant this way.
...
// in `twin-deliver/scripts/deliver.mjs`) and a describes-what-it-calls mention (`registerRoot`,
