 ...
 *   4. Scripts outside `proof/`. A SKILL's own seed renders (`skills/twin-chart-web/scripts/
 *      render-web.mjs`, `skills/twin-scrolly/scripts/render-scrolly.mjs`,
 *      `skills/twin-chart-video/scripts/render-video.mjs`) still default to `/tmp`, and that is a
 *      DIFFERENT question: a seed render is a demonstration with no committed artifact to make
 *      stale — except `skills/twin-chart-video/scripts/render-video.mjs`, whose `--data` default is
