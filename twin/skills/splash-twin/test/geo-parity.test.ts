 ...
 *
 * Eighteen files (`proof/*​/geo-*.ts`, `twin-map-beat/assets/geo.ts`,
 * `twin-map-web/assets/geo-symbol.ts`), 6,400+ lines, guarded by nothing before this file:
 * `helper-parity.test.ts`'s hand-written list names not one `geo-*` function, and
 * `twin-map-beat/test/geo.test.ts` exercises only the skill's own copy.
 *
