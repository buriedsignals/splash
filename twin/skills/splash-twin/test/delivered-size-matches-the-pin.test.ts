 ...
 *
 * Measured 2026-08-11: 76 beats hold a `BRIEF.md`; one pins a size. The rest are the migration —
 * 16 further chart statics, 19 chart videos, 18 chart webs, the map and image genres, and the
