...
/** A DUPLICATE of `twin-map-web/scripts/verify-interaction.mjs`'s own `resolveChrome`, for the same
...
// minutes, not seconds — the same budget `twin-map-web/test/canon.test.ts` already spends on
