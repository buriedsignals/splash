...
const SURVEY = join(SKILLS, "twin-storyboard", "references", "type-survey.md");

const SHEET_DIRS = [
  join(SKILLS, "twin-chart-beat", "references", "types"),
  join(SKILLS, "twin-map-beat", "references", "types"),
];
