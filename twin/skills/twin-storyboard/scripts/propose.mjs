...
// project's established shape for journalist-facing text (`twin-palette/scripts/format-proposal.mjs`,
// `twin-newsroom-charter/scripts/format-proposal.mjs`, `twin-deliver/scripts/format-handover.mjs`):
