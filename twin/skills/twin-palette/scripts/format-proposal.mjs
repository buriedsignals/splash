// twin/skills/twin-palette/scripts/format-proposal.mjs
//
...
//
// This mirrors `twin-newsroom-charter/scripts/format-proposal.mjs` on purpose: a journalist meets
...
export function formatProposal(proposal) {
  ...
  if (options.length === 0) {
    return [
      ...
      "Two ways forward:",
      "",
      "- Run `twin-newsroom-charter` against the newsroom's own site to draft a `NEWSROOM.md`, then",
      "  come back here.",
      `- ${escape}`,
    ].join("\n");
  }
