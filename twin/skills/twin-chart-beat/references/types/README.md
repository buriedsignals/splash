...
against the doctrine in `twin-chart-beat/references/static-discipline.md` and
`twin-doctrine/references/`. It will tell you the trap this type specifically falls into, so you
