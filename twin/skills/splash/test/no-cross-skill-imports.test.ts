 ...
 * shipped files that imported a story workspace instead (`chart-video/assets/EmissionsVideo.tsx`
 * reaching for `proof/co2-suisse/crossing-geometry`, `chart-web/scripts/render-web.mjs` for
 ...
 *
 *   - relative (`./`, `../`, any depth) AND absolute (`/Users/…/skills/chart-beat/…`) paths
 ...
 *     Measured, not assumed: `import("file:///…/chart-beat/…")` loads the real sibling under
 ...
 *     `from "../../chart-video/assets/timing"` — the exact shape three of the nine original
 *     violations took — is caught.
 *   - JS escape sequences are decoded, so `"\x2e\x2e/\x2e\x2e/chart-beat/…"` is read as the
 ...
 * `throw new Error("../../chart-beat/scripts/render-still.mjs was moved, update your fixture path")`
...
// walks, not a list this guard invented. `map-beat/assets/timing.ts` used to import
// `../../chart-video/assets/timing`, no extension, three sites — TypeScript's own everyday
 ...
 * `"\x2e\x2e/chart-beat"` arrives here spelled with backslashes and reaches the filesystem as
 ...
 * an ABSOLUTE path (`/Users/…/skills/chart-beat/scripts/render-still.mjs`) is as much an import
 ...
 * `"../../chart-beat/scripts/render-still.mjs was moved, update your fixture path"` (a real
