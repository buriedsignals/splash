 ...
 * left `chart-video/scripts/render-still.mjs`'s own `deriveFurniture` unguarded, and a real
...
// `chart-web/test/render-web.test.ts` for the same underlying rasteriser.
...
import { measureText as beatMeasure } from "../../chart-beat/scripts/render-still.mjs";
import { measureText as videoRasterMeasure } from "../../chart-video/scripts/render-still.mjs";
import { measureText as webRasterMeasure } from "../../chart-web/scripts/render-still.mjs";
import { measureText as mapRasterMeasure } from "../../map-beat/scripts/render-still.mjs";
import { measureText as sharedRasterMeasure } from "../../../shared/chart-beat/render-still.mjs";
import { measureText as rootTemplateRasterMeasure } from "../assets/root-template/shared/chart-beat/render-still.mjs";
...
// hole — `chart-video/scripts/render-still.mjs`'s deriveFurniture drifted 0.18 -> 0.40 and
// the suite stayed green while only 3 of 6 copies were wired.
import { deriveFurniture as beatFurniture } from "../../chart-beat/scripts/render-still.mjs";
import { deriveFurniture as videoRasterFurniture } from "../../chart-video/scripts/render-still.mjs";
import { deriveFurniture as webRasterFurniture } from "../../chart-web/scripts/render-still.mjs";
import { deriveFurniture as mapFurniture } from "../../map-beat/scripts/render-still.mjs";
import { deriveFurniture as sharedFurniture } from "../../../shared/chart-beat/render-still.mjs";
import { deriveFurniture as rootTemplateFurniture } from "../assets/root-template/shared/chart-beat/render-still.mjs";

// contrast — the WCAG ratio, duplicated into `palette` because that skill proposes colours
...
import { contrast as beatContrast } from "../../chart-beat/scripts/render-still.mjs";
import { contrast as videoRasterContrast } from "../../chart-video/scripts/render-still.mjs";
import { contrast as webRasterContrast } from "../../chart-web/scripts/render-still.mjs";
import { contrast as mapRasterContrast } from "../../map-beat/scripts/render-still.mjs";
import { contrast as sharedContrast } from "../../../shared/chart-beat/render-still.mjs";
import { contrast as rootTemplateContrast } from "../assets/root-template/shared/chart-beat/render-still.mjs";
import { contrast as paletteContrast } from "../../palette/scripts/palette.mjs";
// contrast, again — `newsroom-charter` gained the same arithmetic on 2026-08-10, when it was
...
// achieves.
import { contrast as charterContrast } from "../../newsroom-charter/scripts/derive-charter.mjs";
...
import { adjustToContrast as paletteAdjust } from "../../palette/scripts/palette.mjs";
import { adjustToContrast as beatAdjust } from "../../chart-beat/scripts/render-still.mjs";
import { adjustToContrast as charterAdjust } from "../../newsroom-charter/scripts/derive-charter.mjs";

// readPalette/parsePalette — the recorded-answer reader, vendored into every render-still copy
// (a beat already imports that module to render at all) and duplicated in `palette`, which
...
import { parsePalette as beatParse } from "../../chart-beat/scripts/render-still.mjs";
import { parsePalette as videoRasterParse } from "../../chart-video/scripts/render-still.mjs";
import { parsePalette as webRasterParse } from "../../chart-web/scripts/render-still.mjs";
import { parsePalette as mapRasterParse } from "../../map-beat/scripts/render-still.mjs";
import { parsePalette as sharedParse } from "../../../shared/chart-beat/render-still.mjs";
import { parsePalette as rootTemplateParse } from "../assets/root-template/shared/chart-beat/render-still.mjs";
import { parsePalette as paletteParse } from "../../palette/scripts/palette.mjs";
...
} from "../../chart-video/assets/EmissionsVideo";
import {
...
} from "../../map-beat/assets/Co2MapVideo";
...
import { wrap as chartSeedWrap } from "../../chart-beat/assets/ChartSeed";
import { wrap as co2MapStillWrap } from "../../map-beat/assets/Co2MapStill";
...
import { wrap as chartWebSeedWrap } from "../../chart-web/assets/ChartWebSeed";
