// twin/skills/twin-scrolly/scripts/bake-plate.mjs
//
...
// from the shape `twin-map-web/scripts/bake-plate.mjs` ships, never an import of it.
//
...
//   bun skills/twin-scrolly/scripts/bake-plate.mjs --out /tmp/plate --width 1000 --height 640
