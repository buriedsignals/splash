 ...
 * exemption `splash-twin/test/no-cross-skill-imports.test.ts` grants.
 *
...
// THIS skill's own copy of the rasteriser helpers, not `twin-chart-beat`'s (which the previous
// version of this file reached for). Both copies are held byte-identical by
// `splash-twin/test/helper-parity.test.ts`; using the local one keeps this file's own dependency
