// twin/skills/twin-chart-web/scripts/verify-entrance.mjs
//
...
//
// Usage:
//   bun skills/twin-chart-web/scripts/verify-entrance.mjs                # renders the seed, drives it
//   bun skills/twin-chart-web/scripts/verify-entrance.mjs --file x.html  # an existing beat
//   bun skills/twin-chart-web/scripts/verify-entrance.mjs --out DIR      # + frames and report.json
//
