...
markers it has found and the ticks it has passed on the distance axis are all the same accent,
because they are all the same fact. The static sibling encodes the three organisational tiers in
three Okabe-Ito hues, which is right for a frame whose only variable is category; this beat's
variable moves, and putting a second categorical hue underneath a moving state would ask a reader to
