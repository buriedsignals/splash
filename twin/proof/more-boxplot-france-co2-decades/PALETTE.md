...
The answer recorded for this beat: a bespoke accent the journalist chose — Okabe-Ito blue, the
value `BRIEF.md` already names — kept over both the house teal and a subject convention.
...
changing it is a newsroom decision, not a migration.
...
data does not carry. The median line and the outlier's value label are ink, not the box colour.
