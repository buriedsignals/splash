...
Measured against this ground: 5.06:1, well clear of the 3:1 non-text floor the accent has to hold
(WCAG 2.2 SC 1.4.11). The words in the chart are not drawn in it — they are ink and muted, both
from `deriveFurniture`.
