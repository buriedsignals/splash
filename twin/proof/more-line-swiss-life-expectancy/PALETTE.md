...
`twin-palette`'s subject option was checked and does not apply. `matchConvention` holds four
...
`twin-palette/references/subject-conventions.md` argues against at length. When no convention
