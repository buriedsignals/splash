...
dots in `#0072B2`, an Okabe-Ito blue chosen before `palette` existed and hard-coded in its
...
Measured with `palette`'s own `contrast`: `#0B7A75` on `#FFFFFF` is 5.18:1, clear of the 3:1
