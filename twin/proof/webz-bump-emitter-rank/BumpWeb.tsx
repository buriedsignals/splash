      ...
      >
        ...
        >
          {/* No root role="img" — this genre's one deliberate departure from the static genre's
              accessibility pattern: that role would flatten every child into one opaque image and
              silence the per-reading hit targets below. `<desc>` still carries the alt text. */}
          <desc>{alt}</desc>
          <rect
            x={0}
            y={0}
