...
// GATE (quality audit P5) shared with dw-chart. One cosmetic wording difference from
// the pre-extraction text was resolved to the neutral "deliverable" (was "map" here,
// "chart" in dw-chart) — no test asserted the literal word; see lib/core/i18n-furniture.test.ts.
