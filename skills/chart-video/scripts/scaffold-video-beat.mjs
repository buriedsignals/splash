...
if (import.meta.main) {
  try {
    ...
    const written = scaffoldBeat({ templates: TEMPLATES, files: FILES, skill: SKILL, medium: "chart", type: args.type, beat: args.beat, staticBeat: args.static, component: args.component, filed: Boolean(args.filed) });
