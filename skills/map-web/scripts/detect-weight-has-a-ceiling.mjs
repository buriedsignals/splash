 ...
 *    1 809 942  mapgen-dot-web/dot-population.html
 ...
 *  delivered pages sitting next to each other by size — 223 243 bytes, the step from
...
export const MARGIN_BYTES = 223243;
