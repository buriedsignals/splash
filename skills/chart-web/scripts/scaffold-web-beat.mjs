 ...
 */
export function scaffoldBeat({ root = DEFAULT_ROOT, templates = TEMPLATES, sheets = SHEETS, type, beat, staticBeat, component }) {
  ...
  return [...planned.map(([target]) => target), "PALETTE.md", "data.csv"].sort();
}
