 ...
 *
 *  The delegated producer's own debt. `produce.mjs` already calls `accentPaintsTheMarks` and
 *  `pageLanguageMatchesStory`, which is what a producer wiring a guard looks like; the rest of
 *  `verify-owned.mjs` has no command.
 */
