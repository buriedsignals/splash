 ...
 *
 *  The photograph beat's own debt. `verify-image.mjs`'s one decision is called from three places;
 *  everything else this skill declares is a distributed detector nothing runs.
 */
