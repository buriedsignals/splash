...
waterfall, dumbbell, slope, bullet, treemap, boxplot, violin, diverging-stacked, pyramid, fan, bump, heatmap, combo, pictogram, gantt, candlestick, sankey, chord, arc** (`spec-to-config.ts`);
...
`scatter`, `pie`, `grouped`, `stacked`, `stacked-area`, `histogram`, `lollipop`, `connected-scatter`, `beeswarm`, `dot-strip`, `waffle`, `radial-bar`, `diverging`, `waterfall`, `dumbbell`, `slope`, `bullet`, `treemap`, `boxplot`, `violin`, `diverging-stacked`, `pyramid`, `fan`, `bump`, `heatmap`, `combo`, `pictogram`, `gantt`, `candlestick`, `sankey`, `chord`, `arc`); `highlight` is
