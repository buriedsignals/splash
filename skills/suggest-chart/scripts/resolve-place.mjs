...
import { geocodePlace, isPeakCandidate } from "../../../lib/geo/geocode.ts";
...
export const EXPECTED_KINDS = ["peak"];
...
if (import.meta.main) {
  ...
  if (!runDirArg || !place)
    fail(
      'usage: resolve-place.mjs <runDir> --place "<name>" [--label "<marker label>"] [--expect peak] [--elevation <m>] [--lang <code>]',
    );
