...
2. **The type sheet becomes a frame, never a choreography.** `choreographyFrame`
   ...
   id. It returns no rows, no cards and no shots: a static beat's choreography — the reading order within one composed frame — choreographed in space, not in time, and never "none" — is
