...
in all three copies (`skills/chart-beat/scripts/render-still.mjs:436`,
`shared/chart-beat/render-still.mjs:436`,
`skills/splash/assets/root-template/shared/chart-beat/render-still.mjs:436`), and the
...
shape and a shape IS an aspect ratio. This is the same lesson `chart-web`'s
