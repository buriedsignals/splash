...
const hexGridSample = JSON.parse(
  readFileSync(
    join(root, "assets", "sample-data", "hex-grid-count.json"),
    "utf8",
  ),
);

const cartogramScaledSample = JSON.parse(
  readFileSync(
    join(root, "assets", "sample-data", "cartogram-scaled.json"),
    "utf8",
  ),
);

const cartogramGridSample = JSON.parse(
  readFileSync(
    join(root, "assets", "sample-data", "cartogram-grid.json"),
    "utf8",
  ),
);
