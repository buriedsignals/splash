...
export async function produceAll(
  ...
  // The newsroom's reusable house-style defaults (skills/splash/src/brand-profile.ts), loaded
  ...
  for (const p of batch) {
    ...
    // into SPLASH_CHANNEL, where the producers' exact-match env parsing cannot
