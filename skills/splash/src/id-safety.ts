...
// Throw a journalist-language error if `id` is not a safe slug. Called at every spine
// point an id reaches a filesystem path, BEFORE any resolve/mkdir/rmSync runs.
