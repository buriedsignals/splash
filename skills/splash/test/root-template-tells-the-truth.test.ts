 ...
 *      MUTATION: delete root-template/shared/chart-video/timing.ts (57 files import it).
 *
...
function specifiers(src: string): string[] {
  ...
  while (i < n) {
    ...
    // second false demand. `newsroom-charter/scripts/extract.mjs` parses HTML, so it holds
