// Remotion composition wrapping the SAME StackedBarChart. Linear master timeline
...
export const StackedBarReveal: React.FC<{ scale?: number; config?: StackedConfig }> = ({ scale = 1, config = sampleConfig }) => {
