...
const sampleConfig = sample as unknown as ParallelConfig;

const HOLD_IN = 0.02;
const HOLD_OUT = 0.12;

export const ParallelReveal: React.FC<{ scale?: number; config?: ParallelConfig }> = ({ scale = 1, config = sampleConfig }) => {
