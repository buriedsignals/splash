...
const marker =
  chart === "bar" ? ".bar" : chart === "scatter" ? ".scatter-dot" : chart === "pie" ? ".pie-slice" : chart === "stacked" ? ".stack-seg" : chart === "slope" ? ".slope-line" : chart === "grouped" ? ".grouped-bar" : chart === "dumbbell" ? ".dumbbell-dot" : chart === "stacked-area" ? ".stacked-area-band" : chart === "heatmap" ? ".heat-cell" : chart === "histogram" ? ".hist-bar" : chart === "diverging" ? ".diverging-bar" : chart === "waterfall" ? ".waterfall-bar" : chart === "lollipop" ? ".lollipop-dot" : chart === "pyramid" ? ".pyramid-bar" : chart === "bullet" ? ".bullet-measure" : chart === "connected-scatter" ? ".connected-path" : chart === "marimekko" ? ".mosaic-cell" : chart === "pictogram" ? ".picto-icon" : chart === "combo" ? ".combo-column" : chart === "gantt" ? ".gantt-bar" : chart === "candlestick" ? ".candle-body" : chart === "sankey" ? ".sankey-link" : chart === "chord" ? ".chord-arc" : chart === "arc" ? ".arc-link" : ".series-line";
