...
console.log(`[snap-contrast ${chart}] OK — ${samples.length} labels clear ${MIN_CONTRAST}:1${concerns.length ? ` (${concerns.length} brand concern[s] kept)` : ""}${furnitureGateApplies(lang) ? `; i18n furniture OK (lang "${lang}")` : ""}.`);
