...
const markSel =
  chart === "bar" || chart === "stacked" || chart === "grouped" || chart === "heatmap" || chart === "histogram" || chart === "diverging" || chart === "waterfall" || chart === "pyramid" || chart === "marimekko" || chart === "combo" || chart === "gantt" || chart === "candlestick"
