...
const marker =
  chart === "bar" ? ".bar" : chart === "scatter" ? ".scatter-dot" : chart === "pie" ? ".pie-slice" : chart === "stacked" ? ".stack-seg" : chart === "slope" ? ".slope-line" : chart === "grouped" ? ".grouped-bar" : chart === "dumbbell" ? ".dumbbell-dot" : chart === "stacked-area" ? ".stacked-area-band" : chart === "heatmap" ? ".heat-cell" : chart === "histogram" ? ".hist-bar" : chart === "diverging" ? ".diverging-bar" : chart === "waterfall" ? ".waterfall-bar" : chart === "lollipop" ? ".lollipop-dot" : chart === "pyramid" ? ".pyramid-bar" : ".series-line";
