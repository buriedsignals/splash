 ...
 *
 *  The vehicle's own debt, and the one the round-six sweep measured directly: ten of `verify-
 *  scrolly.mjs`'s thirteen decisions are declared in the file its own driving run never asks.
 */
