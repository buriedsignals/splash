// skills/map-beat/scripts/static-plumbing.mjs
//
// Shared machinery for `scaffold-static-map-beat.mjs` (this skill) — `chart-beat`'s own copy backs
// `scaffold-static-beat.mjs` (skills never import across a skill boundary at runtime,
