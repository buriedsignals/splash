...
mechanism is `chart-beat/scripts/annotation-ink.mjs` — `marksUnder` finds what the annotation
...
`splash/test/annotation-reads-over-what-it-crosses.test.ts`. Its one measurement decision is
