...
- **RESTE parité** : **Slice 3** (harnais vérif : `snap-responsive.mjs` 360→1600 + `snap-a11y.mjs` pour maps) · **Slice 4** (KB : `map/design-conformance.md` global + `map/types/choropleth.md`). Specs à écrire au fil.
