> **SUPERSEDED IN PART 2026-09-18** — the page's sign-in and copy-token button were removed on 2026-09-18; the page is anonymous (see the spec's revision note). Kept for the record; do not execute as written.
