# Splash flow dry-run — GUIDED path

**Case:** case33 — global unemployment rates (bar chart)  
**Config used:** `docs/splash/workflow-tests/case33/config.json`  
**Article:** `docs/splash/workflow-tests/case33/article.md`  
**Date:** 2026-07-04
...
Journalist provides:
- Article: `docs/splash/workflow-tests/case33/article.md` (Wikipedia-sourced unemployment comparison, 16 countries)
...
```bash
bun skills/splash/scripts/export-code.mjs /tmp/flow-guided /tmp/flow-guided-export
```
