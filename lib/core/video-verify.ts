...
// so it is unit-testable with synthetic in-memory frames (video-verify.test.ts).
// Canonical home for chart-native and map-native's snap-video guard: both engines'
// src/core/video-verify.ts re-export this module (same producer discipline,
// mirror-pattern like snap-a11y/snap-proof) — keep behaviour byte-identical.
