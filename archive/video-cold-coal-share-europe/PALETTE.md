...
**In this video** the directed renders take each filed direction's own ground and accent (`renders/<id>.mp4`); the
fossil convention survives as the ramp's hue: the classes are a neutral ramp from the direction's ground toward its
own ink — grey, the material's colour — and the accent is spent on Poland alone (its outline, its word, the half
notched on the gauges and marked on the key).
