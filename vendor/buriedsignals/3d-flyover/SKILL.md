...
Read `references/architecture.md` for camera math, `references/data-sources.md` for provider details,
and `references/troubleshooting.md` for blank, coarse, unauthorized or timed-out renders.

## Files

- `assets/CesiumFlythrough.tsx` — reusable two-mode component with curved-path smoothing.
...
- `assets/sample-river.geojson` — sample input for the route-preparation script.
- `assets/preview.png` — landscape reference still.
