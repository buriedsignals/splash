...
record of this dead-end. The canonical render path is the Remotion component (`../assets/CesiumFlythrough.tsx`).
...
- Cesium loads from **CDN**; set `window.CESIUM_BASE_URL` *before* injecting the script.
